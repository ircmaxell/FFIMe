...
class testFFI {
    ...
    public function add2(int $a, int $b): int {
        $result = $this->_ffi_internal_add2($a, $b);
        return $result;
    }
    private function _ffi_internal_add2(int $a, int $b): int {
        $a = (function ($cdata, $val) { $cdata->cdata = $val; return $cdata; })($this->ffi->new("int"), $a);
        $b = (function ($cdata, $val) { $cdata->cdata = $val; return $cdata; })($this->ffi->new("int"), $b);
...
class long_ptr implements itest, itest_ptr, \ArrayAccess {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public static function castFrom(itest $data): self { return testFFI::cast($data, self::class); }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(long_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): long_ptr_ptr { return new long_ptr_ptr(FFI::addr($this->data)); }
    ...
    public function set(int | void_ptr | long_ptr $value): void {
        if (\is_scalar($value)) {
            $this->data[0] = $value;
        } else {
            FFI::addr($this->data)[0] = $value->getData();
    ...
    public static function getType(): string { return 'long*'; }
    public static function size(): int { return testFFI::sizeof(self::class); }
    public function getDefinition(): string { return static::getType(); }
}
class long_ptr_ptr implements itest, itest_ptr, \ArrayAccess {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public static function castFrom(itest $data): self { return testFFI::cast($data, self::class); }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(long_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): long_ptr_ptr_ptr { return new long_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): long_ptr { return new long_ptr($this->data[$n]); }
    #[\ReturnTypeWillChange] public function offsetGet($offset): long_ptr { return $this->deref($offset); }
    #[\ReturnTypeWillChange] public function offsetExists($offset): bool { return !FFI::isNull($this->data); }
    #[\ReturnTypeWillChange] public function offsetUnset($offset): void { throw new \Error("Cannot unset C structures"); }
    #[\ReturnTypeWillChange] public function offsetSet($offset, $value): void { $this->data[$offset] = $value->getData(); }
    public static function array(int $size = 1): self { return testFFI::makeArray(self::class, $size); }
    /** @return long_ptr[] */ public function toArray(?int $length = null): array { $ret = []; if ($length === null) { $i = 0; while (null !== $cur = $this->data[$i++]) { $ret[] = new long_ptr($cur); } } else { for ($i = 0; $i < $length; ++$i) { $ret[] = new long_ptr($this->data[$i]); } } return $ret; }
    public function set(void_ptr | long_ptr_ptr $value): void {
        FFI::addr($this->data)[0] = $value->getData();
    }
    public static function getType(): string { return 'long**'; }
    public static function size(): int { return testFFI::sizeof(self::class); }
...
class long_ptr_ptr_ptr implements itest, itest_ptr, \ArrayAccess {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public static function castFrom(itest $data): self { return testFFI::cast($data, self::class); }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(long_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): long_ptr_ptr_ptr_ptr { return new long_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): long_ptr_ptr { return new long_ptr_ptr($this->data[$n]); }
    #[\ReturnTypeWillChange] public function offsetGet($offset): long_ptr_ptr { return $this->deref($offset); }
    #[\ReturnTypeWillChange] public function offsetExists($offset): bool { return !FFI::isNull($this->data); }
    #[\ReturnTypeWillChange] public function offsetUnset($offset): void { throw new \Error("Cannot unset C structures"); }
    #[\ReturnTypeWillChange] public function offsetSet($offset, $value): void { $this->data[$offset] = $value->getData(); }
    public static function array(int $size = 1): self { return testFFI::makeArray(self::class, $size); }
    /** @return long_ptr_ptr[] */ public function toArray(?int $length = null): array { $ret = []; if ($length === null) { $i = 0; while (null !== $cur = $this->data[$i++]) { $ret[] = new long_ptr_ptr($cur); } } else { for ($i = 0; $i < $length; ++$i) { $ret[] = new long_ptr_ptr($this->data[$i]); } } return $ret; }
    public function set(void_ptr | long_ptr_ptr_ptr $value): void {
        FFI::addr($this->data)[0] = $value->getData();
    }
    public static function getType(): string { return 'long***'; }
    public static function size(): int { return testFFI::sizeof(self::class); }
...
class long_ptr_ptr_ptr_ptr implements itest, itest_ptr, \ArrayAccess {
    private FFI\CData $data;
    public function __construct(FFI\CData $data) { $this->data = $data; }
    public static function castFrom(itest $data): self { return testFFI::cast($data, self::class); }
    public function getData(): FFI\CData { return $this->data; }
    public function equals(long_ptr_ptr_ptr_ptr $other): bool { return $this->data == $other->data; }
    public function addr(): long_ptr_ptr_ptr_ptr_ptr { return new long_ptr_ptr_ptr_ptr_ptr(FFI::addr($this->data)); }
    public function deref(int $n = 0): long_ptr_ptr_ptr { return new long_ptr_ptr_ptr($this->data[$n]); }
    #[\ReturnTypeWillChange] public function offsetGet($offset): long_ptr_ptr_ptr { return $this->deref($offset); }
    #[\ReturnTypeWillChange] public function offsetExists($offset): bool { return !FFI::isNull($this->data); }
    #[\ReturnTypeWillChange] public function offsetUnset($offset): void { throw new \Error("Cannot unset C structures"); }
    #[\ReturnTypeWillChange] public function offsetSet($offset, $value): void { $this->data[$offset] = $value->getData(); }
    public static function array(int $size = 1): self { return testFFI::makeArray(self::class, $size); }
    /** @return long_ptr_ptr_ptr[] */ public function toArray(?int $length = null): array { $ret = []; if ($length === null) { $i = 0; while (null !== $cur = $this->data[$i++]) { $ret[] = new long_ptr_ptr_ptr($cur); } } else { for ($i = 0; $i < $length; ++$i) { $ret[] = new long_ptr_ptr_ptr($this->data[$i]); } } return $ret; }
    public function set(void_ptr | long_ptr_ptr_ptr_ptr $value): void {
        FFI::addr($this->data)[0] = $value->getData();
    }
    public static function getType(): string { return 'long****'; }
    public static function size(): int { return testFFI::sizeof(self::class); }
